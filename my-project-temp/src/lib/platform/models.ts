...
export const MODEL_REGISTRY: ModelDefinition[] = [
  ...
  },
  {
    ...
    inputCostCentsPer1M: 500,
    outputCostCentsPer1M: 3000,
    supportsStreaming: true,
    supportsTools: true,
    supportsVision: true,
    description: 'OpenAI frontier model. Best for hard planning + research.',
    badge: 'powerful',
  },
  ...
  },
  {
    ...
    supportsTools: true,
    supportsVision: true,
    description: 'Google deep-reasoning model for complex agentic workflows.',
    badge: 'powerful',
  },
  ...
  // ---- xAI / Grok (hosted) ----
  {
    ...
    inputCostCentsPer1M: 125,
    outputCostCentsPer1M: 250,
    supportsStreaming: true,
    supportsTools: true,
    supportsVision: true,
